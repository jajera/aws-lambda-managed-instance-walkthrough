...
Deeper **comparison**, **economics**, and **integrations** are consolidated here so **[LMI fundamentals](/overview/concepts/)** articles stay concise. Account and local tooling live under **[Foundations](/foundations/)** and **[Prerequisites](/foundations/prerequisites/)**. Step-by-step apply procedures will ship under **[Walkthrough](/walkthrough/)**; this page stays conceptual until those batches exist.
