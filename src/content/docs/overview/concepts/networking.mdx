...
Subnet choice, route tables, security groups, and endpoint policies are part of **capacity provider** placement — see [Placement & capacity](/overview/concepts/capacity-providers/).
