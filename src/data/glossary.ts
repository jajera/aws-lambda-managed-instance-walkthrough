export const glossary: Record<string, string> = {
  ...
  grafana: 'Grafana — an open-source observability platform for visualising metrics and logs; used with Loki in this walkthrough.',
  ...
  lambda: 'AWS Lambda — a serverless compute service that runs code in response to events without provisioning servers.',
  ...
  logql: 'LogQL — the Grafana Loki query language, similar to PromQL, used to filter and aggregate log streams by label and content.',
  'managed-instances':
  ...
  nodejs: 'Node.js — the JavaScript runtime used for the Lambda handler in this walkthrough (version 24.x, async/await only).',
  ...
  subnet: 'Subnet — a segment of a VPC CIDR block in a single Availability Zone; Lambda Managed Instances run in private subnets.',
  ...
  'web-acl': 'Web ACL — a Web Application Firewall access control list; a named set of rules that WAF evaluates against incoming requests.',
};
