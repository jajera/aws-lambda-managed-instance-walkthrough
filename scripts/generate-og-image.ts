...
<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="630" viewBox="0 0 1200 630" role="img">
  ...
  <text x="72" y="120" fill="#22d3ee" font-family="Segoe UI, Helvetica, Arial, sans-serif" font-size="28" font-weight="700" letter-spacing="0.08em">LAMBDA · MANAGED INSTANCES</text>
  <text x="72" y="220" fill="#eef8fa" font-family="Segoe UI, Helvetica, Arial, sans-serif" font-size="64" font-weight="800">Capacity providers,</text>
  <text x="72" y="295" fill="#eef8fa" font-family="Segoe UI, Helvetica, Arial, sans-serif" font-size="64" font-weight="800">VPC, Terraform labs</text>
  <text x="72" y="380" fill="#b7cdd4" font-family="Segoe UI, Helvetica, Arial, sans-serif" font-size="28">Walkthrough for AWS Lambda Managed Instances</text>
  ...
  <text x="72" y="560" fill="#5a7a86" font-family="Segoe UI, Helvetica, Arial, sans-serif" font-size="22">aws-lambda-managed-instance-walkthrough.johna.kiwi</text>
</svg>
`;
